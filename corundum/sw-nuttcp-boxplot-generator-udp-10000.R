...
bp <- boxplot(data_matrix, horizontal=TRUE, main="Conf. 2 - nuttcp UDP throughput (10Gbps injection bitrate)", xlab="Throughput (Mbps)", ylab="Buffer size", col=c("lightblue", "lightgreen"), outline=TRUE)
...
svg("boxplots/two-nuttcp-boxplot-udp-throughput-10000.svg")
boxplot(data_matrix, horizontal=TRUE, main="Conf. 2 - nuttcp UDP throughput (10Gbps injection bitrate)", xlab="Throughput (Mbps)", ylab="Buffer size", col=c("lightblue", "lightgreen"), outline=TRUE)
legend("topleft", legend=legend_labels, fill=c("lightblue", "lightgreen"), cex = 0.7)
dev.off()