...
data1 <- read.table("sin-switch/netperf/udp-box-plot-1024-512.txt", header = FALSE)
data2 <- read.table("sin-switch/netperf/udp-box-plot-1024-1024.txt", header = FALSE)
data3 <- read.table("sin-switch/netperf/udp-box-plot-1024-2048.txt", header = FALSE)
data4 <- read.table("sin-switch/netperf/udp-box-plot-1024-4096.txt", header = FALSE)
data5 <- read.table("sin-switch/netperf/udp-box-plot-1024-8192.txt", header = FALSE)
data6 <- read.table("sin-switch/netperf/udp-box-plot-1024-16384.txt", header = FALSE)
