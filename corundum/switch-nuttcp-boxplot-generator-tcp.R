...
data1 <- read.table("con-switch/nuttcp/tcp-box-plot-212992.txt", header = FALSE)
data2 <- read.table("con-switch/nuttcp/tcp-box-plot-157286400.txt", header = FALSE)
...
svg("boxplots/switch-nuttcp-boxplot-tcp-throughput.svg")
