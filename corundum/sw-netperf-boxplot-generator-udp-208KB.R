...
data1 <- read.table("con-switch/netperf/udp-box-plot-208-512.txt", header = FALSE)
data2 <- read.table("con-switch/netperf/udp-box-plot-208-1024.txt", header = FALSE)
data3 <- read.table("con-switch/netperf/udp-box-plot-208-2048.txt", header = FALSE)
data4 <- read.table("con-switch/netperf/udp-box-plot-208-4096.txt", header = FALSE)
data5 <- read.table("con-switch/netperf/udp-box-plot-208-8192.txt", header = FALSE)
data6 <- read.table("con-switch/netperf/udp-box-plot-208-16384.txt", header = FALSE)
...
bp <- boxplot(data_matrix, horizontal=FALSE, main="Conf. 2 - netperf UDP throughput (208 KB)", ylab="Throughput (Mbps)", xlab="Message size", col=c("lightblue", "lightgreen", "lightcoral", "lightyellow", "lightpink", "lightgray"), outline=FALSE)
...
svg("boxplots/two-netperf-boxplot-udp-throughput-208kb.svg")
