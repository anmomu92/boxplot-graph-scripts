...
data1 <- read.table("sin-switch/iperf3/udp-box-plot-104-0.txt", header = FALSE)
data2 <- read.table("sin-switch/iperf3/udp-box-plot-208-0.txt", header = FALSE)
data3 <- read.table("sin-switch/iperf3/udp-box-plot-512-0.txt", header = FALSE)
data4 <- read.table("sin-switch/iperf3/udp-box-plot-1024-0.txt", header = FALSE)
data5 <- read.table("sin-switch/iperf3/udp-box-plot-10240-0.txt", header = FALSE)
data6 <- read.table("sin-switch/iperf3/udp-box-plot-51200-0.txt", header = FALSE)
