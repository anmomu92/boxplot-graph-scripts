...
data1 <- read.table("sin-switch/netperf/tcp-box-plot-212992.txt", header = FALSE)
data2 <- read.table("sin-switch/netperf/tcp-box-plot-157286400.txt", header = FALSE)
...
svg("boxplots/one-netperf-boxplot-tcp-throughput.svg")
