...
data1 <- read.table("con-switch/iperf3/udp-box-plot-104-0.txt", header = FALSE)
data2 <- read.table("con-switch/iperf3/udp-box-plot-208-0.txt", header = FALSE)
data3 <- read.table("con-switch/iperf3/udp-box-plot-512-0.txt", header = FALSE)
data4 <- read.table("con-switch/iperf3/udp-box-plot-1024-0.txt", header = FALSE)
data5 <- read.table("con-switch/iperf3/udp-box-plot-10240-0.txt", header = FALSE)
data6 <- read.table("con-switch/iperf3/udp-box-plot-51200-0.txt", header = FALSE)
...
svg("boxplots/switch-iperf3-boxplot-udp-throughput-0-six-buffer.svg")
