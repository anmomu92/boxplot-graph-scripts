...
data1 <- read.table("con-switch/nuttcp/udp-box-plot-212992-0.txt", header = FALSE)
data2 <- read.table("con-switch/nuttcp/udp-box-plot-157286400-0.txt", header = FALSE)
...
svg("boxplots/switch-nuttcp-boxplot-udp-throughput-0.svg")
