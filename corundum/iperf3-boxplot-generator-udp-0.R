...
data1 <- read.table("sin-switch/iperf3/udp-box-plot-212992-0.txt", header = FALSE)
data2 <- read.table("sin-switch/iperf3/udp-box-plot-157286400-0.txt", header = FALSE)
...
svg("boxplots/one-iperf3-boxplot-udp-throughput-0.svg")
