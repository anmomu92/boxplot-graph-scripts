...
bp <- boxplot(data_matrix, horizontal=TRUE, main="iperf3 UDP throughput (10 GB injection bitrrate)", xlab="Throughput (Mbps)", ylab="Buffer size", col=c("lightblue", "lightgreen"), outline=TRUE)
