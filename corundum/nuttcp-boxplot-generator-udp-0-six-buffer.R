...
data1 <- read.table("sin-switch/nuttcp/udp-box-plot-104-0.txt", header = FALSE)
data2 <- read.table("sin-switch/nuttcp/udp-box-plot-208-0.txt", header = FALSE)
data3 <- read.table("sin-switch/nuttcp/udp-box-plot-512-0.txt", header = FALSE)
data4 <- read.table("sin-switch/nuttcp/udp-box-plot-1024-0.txt", header = FALSE)
data5 <- read.table("sin-switch/nuttcp/udp-box-plot-10240-0.txt", header = FALSE)
data6 <- read.table("sin-switch/nuttcp/udp-box-plot-51200-0.txt", header = FALSE)
...
bp <- boxplot(data_matrix, horizontal=FALSE, main="Conf. 1 - nuttcp UDP throughput (no injection limit)", ylab="Throughput (Mbps)", xlab="Buffer size", col=c("lightblue", "lightgreen", "lightcoral", "lightyellow", "lightpink", "lightgray"), outline=TRUE)
...
svg("boxplots/one-nuttcp-boxplot-udp-throughput-0-six-buffer.svg")
